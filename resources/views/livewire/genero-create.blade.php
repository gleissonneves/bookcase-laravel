...
<div class="w-full bg-white rounded shadow-lg p-8 m-3 md:max-w-sm md:mx-auto">
    <h1 class="block w-full text-lg font-semibold text-center text-grey-darkest mb-6">
        Nos fale o genero Literário <br>
        do livro
    </h1>
    <form class="mb-4 md:flex md:flex-wrap md:justify-between" action="/" method="post">
        ...
        <div class="flex flex-col mb-4 md:w-full">
            <label class="mb-2 font-light tracking-wide text-lg text-grey-darkest" for="data_publicacao">Data de publicação</label>
            <input class="border focus:outline-none py-2 px-3 text-grey-darkest md:mr-2" type="date" name="" id="data_publicacao">
            <div>
