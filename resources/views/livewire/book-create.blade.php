    ...
    <div class="flex">
        <div class="w-1/4">
            <div class="relative mb-2">
                <div class="w-10 h-10 mx-auto bg-purple-700 rounded-full text-lg text-white flex items-center">
            ...
            <div class="text-xs text-center md:text-base">Livro</div>
        </div>
        ...
        <div class="w-1/4">
            <div class="relative mb-2">
                <div class="absolute flex align-center items-center align-middle content-center"
                    ...
                    <div class="w-full bg-gray-200 rounded items-center align-middle align-center flex-1">
                        <div class="w-0 bg-purple-400 py-1 rounded" style="width: 100%;"></div>
                    </div>
                </div>
            ...
            <div class="text-xs text-center md:text-base">Gênero</div>
        </div>
        ...
        <div class="w-1/4">
            ...
            <div class="text-xs text-center md:text-base">Autor</div>
        </div>
...
<div class="w-full bg-white rounded shadow-lg p-8 m-3 md:max-w-sm md:mx-auto">
    <h1 class="block w-full text-lg font-semibold text-center text-grey-darkest mb-6">Cadastro de livros</h1>
    <form class="mb-4 md:flex md:flex-wrap md:justify-between" action="/" method="post">
        ...
        <div class="flex flex-col mb-4 md:w-full">
            ...
            <textarea class="border focus:outline-none py-2 px-3 text-grey-darkest" type="email" name="email"
                id="email"></textarea>
        </div>
